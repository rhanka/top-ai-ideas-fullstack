...
- BR-14f owns the repo/tooling baseline only; BR-14c still owns the `@sentropic/llm-mesh` contract and its API proof after rebase.
- Durable activation details live in `README.md`, `README.fr.md`, `rules/architecture.md`, `PLAN.md`, and `spec/SPEC_EVOL_SENTROPIC_BR14_ORCHESTRATION.md`.
...
- BR-14c is the next activation branch and must prove `api/` consumes `@sentropic/llm-mesh` through the root workspace.
