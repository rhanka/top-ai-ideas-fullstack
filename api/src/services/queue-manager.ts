...
const AUTO_GENERATION_COMMENT = 'Draft generated by AI assistant. Please review and adjust if needed.';
...
export class QueueManager {
  ...
  private async createAutoGenerationComment(opts: {
    workspaceId: string;
    ...
    await db.insert(comments).values({
      ...
      status: 'open',
      threadId: createId(),
      content: AUTO_GENERATION_COMMENT,
      toolCallId: null,
      createdAt: now,
      updatedAt: now
    });
  ...
  private async processOrganizationEnrich(data: OrganizationEnrichJobData, jobId: string, signal?: AbortSignal): Promise<void> {
    ...
    await this.createAutoGenerationComment({
      workspaceId,
