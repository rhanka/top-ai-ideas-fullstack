...
export async function generateWebAuthnAuthenticationOptions(
  ...
  // Generate authentication options (let @simplewebauthn/server generate the challenge)
  ...
  // Store the challenge generated by @simplewebauthn/server
  const challengeRecord = await generateChallenge({
    userId,
    type: 'authentication',
    challenge: options.challenge, // Use the challenge from the options
