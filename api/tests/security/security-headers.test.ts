...
describe('Security Headers Tests', () => {
  ...
  describe('Content Security Policy (CSP)', () => {
    ...
    it('should include CSP header on error responses', async () => {
      // Test 404 response
      const response = await authenticatedRequest(app, 'GET', '/api/v1/companies/non-existent-id', null, {}, user);
  ...
  describe('Security Headers on Different Endpoints', () => {
    ...
    it('should include security headers on error responses', async () => {
      ...
      const response = await authenticatedRequest(app, 'POST', '/api/v1/companies', {
  ...
  describe('Security Headers Consistency', () => {
    it('should have consistent security headers across all endpoints', async () => {
      const endpoints = [
        ...
        () => authenticatedRequest(app, 'GET', '/api/v1/folders', null, {}, user),
        () => authenticatedRequest(app, 'GET', '/api/v1/useCases', null, {}, user),
        () => authenticatedRequest(app, 'GET', '/api/v1/settings', null, {}, user),
