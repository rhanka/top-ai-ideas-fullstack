...
## Plan / Todo
- [ ] Confirm storage approach (MinIO local vs Scaleway S3) and env variables to standardize.
- [ ] Add DB tables + migration + update `spec/DATA_MODEL.md`.
...
## Commits & Progress
- [ ] **Commit 1**: docs branch setup (this file) + design skeleton
- [ ] **Commit 2**: DB schema + migration + DATA_MODEL update
...
- **Current**: writing plan + auditing existing queue/storage patterns
- **Next**: commit BRANCH.md, then implement DB schema/migration for `context_documents`
