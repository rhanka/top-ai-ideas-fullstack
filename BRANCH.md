...
- [x] Step 1: regression gates: `make typecheck-api ENV=test-refacto-chat-service-core API_PORT=9070 UI_PORT=5270 MAILDEV_UI_PORT=1170` PASS, `make test-pkg-chat-core ENV=...` PASS (211/211; no test added in Step 1 — tests land in Step 3).
